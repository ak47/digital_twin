...
Env (injected by Terraform / Cloud Run):
  ...
  RAG_CORPUS_RESOURCE     — full ragCorpora/... name; includes region (e.g. .../locations/europe-west4/ragCorpora/...). Retrieval uses that region; Gemini still uses GCP_REGION.
